# Extract worker orchestration into projects/references/worker.md (braids-w9g)
...
- This supersedes `braids-a2z` (agent strategy docs) since the orchestration is now documented in the reference file.
