...
## Details
Budget can't be meaningfully enforced — no reliable cumulative cost/token tracking is available. Removed all references:

1. **PROJECT.md** — Removed `Budget: unlimited` line
