...
1. **Orchestrator** (cron job) — Runs every 5 minutes. Reads registry, finds active iterations, checks concurrency, and spawns workers via `braids orch --live-run`. Does NO bead work itself. See `references/orchestrator.md`.
